...
import { Table, Divider, Modal, Button, Icon, Upload, Form, Input, Col, Row, Popconfirm,Select } from 'antd';
    ...
    return (
      <React.Fragment>
        ...
        <Row>
            ...
            <Select defaultValue="DEFECTTRACKER" style={{ width: 120 }} onChange={this.handleChange}>
